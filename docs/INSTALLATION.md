...
Проверить статусы в панели. Для проверки доставки предусмотрена кнопка тестового Telegram-сообщения на этапе реализации; сам факт её наличия необходимо включить в UI и тест приёмки.
